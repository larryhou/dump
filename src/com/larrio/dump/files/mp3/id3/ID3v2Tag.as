package com.larrio.dump.files.mp3.id3
{
	...
	import com.larrio.dump.files.mp3.id3.frames.ID3Frame;
	import com.larrio.dump.files.mp3.id3.frames.ID3FrameFactory;
	import com.larrio.dump.files.mp3.id3.frames.headers.ID3FrameHeaderFactory;
	import com.larrio.dump.files.mp3.id3.headers.ID3ExtendHeader;
	import com.larrio.dump.files.mp3.id3.headers.ID3Footer;
	import com.larrio.dump.files.mp3.id3.headers.ID3Header;
