package com.larrio.dump.tags
{
	 ...
	 * TAG类型常量
	 * @author larryhou
	 * @createTime Dec 16, 2012 1:57:57 PM
	 */
	public class TagType
	{
		public static const CSM_TEXT_SETTINGS                  :uint = 0x4A; // 74
		
		public static const DEFINE_BINARY_DATA                 :uint = 0x57; // 87
		
		public static const DEFINE_BITS                        :uint = 0x6;  // 6
		public static const DEFINE_BITS_JPEG2                  :uint = 0x15; // 21
		public static const DEFINE_BITS_JPEG3                  :uint = 0x23; // 35
		public static const DEFINE_BITS_JPEG4                  :uint = 0x5A; // 90
		
		public static const DEFINE_BITS_LOSSLESS               :uint = 0x14; // 20
		public static const DEFINE_BITS_LOSSLESS2              :uint = 0x24; // 36
		
		public static const DEFINE_BUTTON                      :uint = 0x7;  // 7
		public static const DEFINE_BUTTON2                     :uint = 0x22; // 34
		...
		public static const DEFINE_FONT2                       :uint = 0x30; // 48
		...
		public static const DEFINE_MORPH_SHAPE2                :uint = 0x54; // 84
		...
		public static const DEFINE_TEXT2                       :uint = 0x21; // 33
		
		public static const DEFINE_VIDEO_STREAM                :uint = 0x3C; // 60
		
		public static const DO_ABC                             :uint = 0x52; // 82
		...
		public static const IMPORT_ASSETS2                     :uint = 0x47; // 71
		
		public static const JPEG_TABLES                        :uint = 0x8;  // 8
		...
		public static const REMOVE_OBJECT2                     :uint = 0x1C; // 28
		
		public static const SCRIPT_LIMITS                      :uint = 0x41; // 65
		
		public static const SET_BACKGROUND_COLOR               :uint = 0x9;  // 9
		
		public static const SET_TABLE_INDEX                    :uint = 0x42; // 66
		
		public static const SHOW_FRAME                         :uint = 0x1;  // 1
		
		public static const SOUND_STEAM_HEAD                   :uint = 0x12; // 18
		public static const SOUND_STEAM_HEAD2                  :uint = 0x2D; // 45
		
		public static const SOUND_STREAM_BLOCK                 :uint = 0x13; // 19
		
		public static const START_SOUND                        :uint = 0xF;  // 15
		public static const START_SOUND2                       :uint = 0x59; // 89
