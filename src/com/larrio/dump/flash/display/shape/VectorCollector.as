package com.larrio.dump.flash.display.shape
{
	...
	public class VectorCollector
	{
		...
		private function drawStyleChange(record:StyleChangeRecord):void
		{
			...
			{
				_position.x = record.moveToX;
				_position.y = record.moveToY;
			}
		...
		private function drawStraightEdge(record:StraightEdgeRecord):void
		{
			...
			edge.x2 = _position.x += record.deltaX;
			edge.y2 = _position.y += record.deltaY;
		...
		private function drawCurvedEdge(record:CurvedEdgeRecord):void
		{
			...
			edge.ctrX = _position.x += record.deltaControlX;
			edge.ctrY = _position.y += record.deltaControlY;
			
			edge.x2 = _position.x += record.deltaAnchorX;
			edge.y2 = _position.y += record.deltaAnchorY;
